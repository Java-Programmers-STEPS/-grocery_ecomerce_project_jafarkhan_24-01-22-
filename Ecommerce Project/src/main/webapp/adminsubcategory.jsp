...
<body
	...
	<!-- add new category -->
	<form>
		<div style="padding-left: 5px;  width: 25%" class="card" id="cardCategory">
			<div class="card-body">
				<div class="form-group" id="categoryField">
					
		<div class="input-box">
					<label for="selectcategory">Select Category :</label> <select
						class="form-control " id="selectcategory">
						<option value="SelectDistrict">Select Category</option>
						<option value="Alappuzha">Fruits</option>
						<option value="Eranakulam">beverages</option>
						<option value="Idukki">grocery</option>
						<option value="kasaragod">baby care</option>
						<option value="Kannur">vegitables</option>
						<option value="Kollam">personal care</option>
					</select>
				...
				<div class="form-group" >
					<label for="exampleInputEmail1"> Create Sub Category</label> <input
						 type="email" class="form-control"
						id="createsubcategory" name="createsubcategory"
						aria-describedby="emailHelp" placeholder="Create Sub Category">
